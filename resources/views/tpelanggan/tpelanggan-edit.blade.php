            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <form action="/tpelanggan-update/{{ $data->id }}" method="post">
                                    @csrf
                                    <div class="mb-3">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control" name="id_pelanggan">
                                                ...
                                                @foreach ($pelanggans as $p)
                                                    <option value="{{ $p->id }}"
                                                        {{ $data->id_pelanggan == $p->id ? 'selected' : '' }}>ID
                                                        {{ $p->id }} -
                                                        {{ $p->nama }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            <select class="form-control" name="id_barang">
                                                ...
                                                @foreach ($barangs as $b)
                                                    <option value="{{ $b->id }}"
                                                        {{ $data->id_barang == $b->id ? 'selected' : '' }}>ID {{ $b->id }} -
                                                        {{ $b->jenis }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" name="total" maxlength="50" required="required"
                                            class="form-control" id="total_transaksi" value="{{ $data->total }}" readonly/>
                                    </div>
                                    <div class="mb-3">

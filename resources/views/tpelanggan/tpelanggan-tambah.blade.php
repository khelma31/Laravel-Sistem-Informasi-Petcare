            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <form action="/tpelanggan-insert" method="post">
                                    @csrf
                                    <div class="mb-3">
                                        <label class="form-label" for="basic-default-company">ID Pelanggan</label>
                                        <div class="form-group">
                                            <select class="form-control" name="id_pelanggan">
                                                <option selected disabled>--Pilih ID Pelanggan--</option>
                                ...
                                <script>
                                    document.getElementById('id_layanan').addEventListener('change', function() {
                                        ...
                                        document.getElementsByName('total')[0].value = harga;
                                    });
                                </script>

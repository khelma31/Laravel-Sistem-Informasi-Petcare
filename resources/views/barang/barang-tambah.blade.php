        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>Tambah Data Barang</h4>
                  ...
                  <div class="card-body">
                    <form action="/barang-insert" method="post">
                          ...
                          <div class="form-group">
                              <select class="form-control" name="id_distributor">
                                  ...
                                  @foreach ($distributors as $distributor)
                                      <option value="{{ $distributor->id }}">ID {{ $distributor->id }} - {{ $distributor->nama }}</option>
                                  @endforeach
                              </select>
                          </div>
                       </div>
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" name="harga" maxlength="50" required="required" class="form-control" id="basic-default-company" />
                      </div>
                      <div class="mb-3">

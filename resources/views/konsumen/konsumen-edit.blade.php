        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>Edit Data Konsumen</h4>
                <div class="card mb-4">
                  <div class="card-body">
                    <form action="/konsumen-update/{{ $data->id }}" method="post">
                      @csrf
                      <div class="mb-3">
                            ...
                            <select class="form-control" name="id_pengguna">
                                ...
                                @foreach ($penggunas as $pengguna)
                                  <option value="{{ $pengguna->id }}"
                                      {{ $data->id_pengguna == $pengguna->id ? 'selected' : '' }}>
                                      {{ $pengguna->username }}
                                  </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            <select class="form-control" name="id_hewan">
                                ...
                                <option value="{{ $hewan->id }}"
                                  {{ $data->id_hewan == $hewan->id ? 'selected' : '' }}>
                                  ID {{ $hewan->id }} - {{ $hewan->nama }}
                              </option>
                                @endforeach
                            </select>
                        </div>

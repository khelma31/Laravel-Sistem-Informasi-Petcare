        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span>Edit Data Hewan</h4>
                <div class="card mb-4">
                  <div class="card-body">
                    <form action="/hewan-update/{{ $data->id }}" method="post">
                      @csrf
                      <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <input type="text" name="jenis_hewan" maxlength="50" required="required" class="form-control" id="basic-default-company" value="{{ $data->jenis_hewan }}" />
                      </div>
                      <div class="mb-3">
